...
def cart_summary(request):
    ...
    shipping = 5
    general_total = totals + shipping
    return render(
        request, "cart.html", {"cart_products": cart_products, "quantities": quantities, "totals": totals, "shipping_cost": shipping, 'general_total': general_total}
    )
